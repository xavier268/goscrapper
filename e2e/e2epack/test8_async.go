...
type Output_test8_async struct {
	zz time.Time
	a struct{titi bool;toto int;tutu []int}
...
func DoAsync_test8_async(_ctx context.Context,_ch chan<- Output_test8_async,  _in Input_test8_async) (_err error) {
var _out Output_test8_async
